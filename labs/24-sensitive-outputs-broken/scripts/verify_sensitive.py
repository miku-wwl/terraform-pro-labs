...
PROBE = "synthetic-lab24-probe-not-a-real-secret"
...
def main() -> int:
    ...
    failures: list[str] = []
    if not variables.get("db_password", {}).get("sensitive", False):
    ...
    if failures:
        ...
        for failure in failures:
            print(f"  - {failure}")
        return 1
    print("Sensitive verification passed: metadata, safe diagnostics, and CLI redaction are correct.")
    return 0
